...
import com.lightning.wallet.ln.{CommitmentSpec, LNParams}
...
import com.lightning.wallet.test.{CommitmentSpecSpec, HtlcGenerationSpec, TransactionsSpec}
...
class MainActivity extends NfcReaderActivity with TimerActivity with ViewSwitch { me =>
  ...
  override def onCreate(savedInstanceState: Bundle) =
  {
    ...
    (new HtlcGenerationSpec).allTests
