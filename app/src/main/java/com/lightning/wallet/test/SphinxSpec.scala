...
class SphinxSpec {
  ...
  def allTests = {

    {
      ...
      println(sharedsecrets(0) == BinaryData("0x53eb63ea8a3fec3b3cd433b85cd62a4b145e1dda09391b348c4e1cd36a03ea66"))
      println(ephkeys(1) == PublicKey(BinaryData("0x028f9438bfbf7feac2e108d677e3a82da596be706cc1cf342b75c7b7e22bf4e6e2")))
      println(sharedsecrets(1) == BinaryData("0xa6519e98832a0b179f62123b3567c106db99ee37bef036e783263602f3488fae"))
      println(ephkeys(2) == PublicKey(BinaryData("0x03bfd8225241ea71cd0843db7709f4c222f62ff2d4516fd38b39914ab6b83e0da0")))
      println(sharedsecrets(2) == BinaryData("0x3a6b412548762f0dbccce5c7ae7bb8147d1caf9b5471c34120b30bc9c04891cc"))
      println(ephkeys(3) == PublicKey(BinaryData("0x031dde6926381289671300239ea8e57ffaf9bebd05b9a5b95beaf07af05cd43595")))
      println(sharedsecrets(3) == BinaryData("0x21e13c2d7cfe7e18836df50872466117a295783ab8aab0e7ecc8c725503ad02d"))
      println(ephkeys(4) == PublicKey(BinaryData("0x03a214ebd875aab6ddfd77f22c5e7311d7f77f17a169e599f157bbcdae8bf071f4")))
      println(sharedsecrets(4) == BinaryData("0xb5756b9b542727dbafc6765a49488b023a725d631af688fc031217e90770c328"))
    }

    {
      ...
      println(filler == BinaryData(""))

      val hopFiller = generateFiller("gamma", sharedsecrets.dropRight(1), 20, 20)
      println(hopFiller == BinaryData("0x2e86897a3ae52daba4a5940cfc305ae15e9a0f8a8ac1033a15d8a14819acab6503c9df44cdaaf30629283e3458844a44a5c4bfdebdcb15fd3edb8e286124d7b47fa7a56bcc5655d2ad9809f108f238e5"))
    }

    {
      ...
      println(Seq(payload0, payload1, payload2, payload3, payload4) == payloads)
      println(Seq(address0, address1, address2, address3, address4) == Seq(publicKeys(1).hash160, publicKeys(2).hash160, publicKeys(3).hash160, publicKeys(4).hash160, zeroes(20)))

      val (_, sharedsecrets) = computeEphemerealPublicKeysAndSharedSecrets(sessionKey, publicKeys)
      println(Seq(sharedSecret0, sharedSecret1, sharedSecret2, sharedSecret3, sharedSecret4) == sharedsecrets)
    }

    {
      println("generate last packet")
      ...
      println(nextPacket4 == BinaryData(""))

      // same as above but in one single step
      // this is what clients will use
      val OnionPacket(_, packet) = makePacket(sessionKey, publicKeys, payloads, associatedData)
      println(packet == nextPacket4)
    }

    {
      println("generate return messages")
      ...
      val Some(ErrorPacket(pubkey, failure1)) = parseErrorPacket(sharedsecrets.zip(publicKeys), error)
      println(pubkey == publicKeys.last)
      println(failure1 == failure)
    }

    {
      ...
      val OnionPacket(sharedSecrets, packet) = makePacket(sessionKey, publicKeys, payloads, associatedData)
