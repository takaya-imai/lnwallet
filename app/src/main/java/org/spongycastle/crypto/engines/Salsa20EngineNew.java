...
import org.spongycastle.util.PackNew;
import org.spongycastle.util.Strings;

/**
 * Implementation of Daniel J. Bernstein's Salsa20 stream cipher, Snuffle 2005
 */
public class Salsa20EngineNew
        implements SkippingStreamCipher
{
    ...
    private final static int[] TAU_SIGMA = PackNew.littleEndianToInt(Strings.toByteArray("expand 16-byte k" + "expand 32-byte k"), 0, 8);
     ...
     */
    public Salsa20EngineNew(int rounds)
    {
    ...
    protected void setKey(byte[] keyBytes, byte[] ivBytes)
    {
        if (keyBytes != null)
        {
            ...
            // Key
            PackNew.littleEndianToInt(keyBytes, 0, engineState, 1, 4);
            PackNew.littleEndianToInt(keyBytes, keyBytes.length - 16, engineState, 11, 4);
        }

        // IV
        PackNew.littleEndianToInt(ivBytes, 0, engineState, 6, 2);
    }

    protected void generateKeyStream(byte[] output)
    {
        salsaCore(rounds, engineState, x);
        PackNew.intToLittleEndian(x, output, 0);
    }
